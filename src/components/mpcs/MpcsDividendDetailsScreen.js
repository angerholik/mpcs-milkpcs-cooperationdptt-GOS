...
export default function MpcsDividendDetailsScreen({
  ...
  React.useEffect(() => {
    if (initialPolicy) setDividendPolicy(initialPolicy);
    if (initialAnnounced) setDividendAnnounced(initialAnnounced);
    if (initialRate) setDividendRate(initialRate);
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.topBarTitleContainer}>
          ...
          <Text style={styles.screenTitleHeader}>Dividend Details</Text>
        </View>
      </View>
        ...
        <View style={[{ flexDirection: 'row', gap: 8 }, webCapWidth]}>
          <View style={styles.btnWrapper}>
            ...
            >
              ...
              <Text style={styles.editCtaText}>Edit Dividend Details</Text>
            </Pressable>
          </View>
        </View>
      </View>
      ...
      <ScrollView style={styles.scrollContent} contentContainerStyle={[styles.scrollInner, webCapWidth]} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.alertCard}>
          <View style={styles.alertIconBox}>
            <MaterialCommunityIcons name="cash-multiple" size={20} color={COLORS.amber900} />
          </View>
          <View style={styles.alertBody}>
            <Text style={styles.alertTitle}>Dividend Details</Text>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeaderRow}>
            ...
            <Text style={styles.cardHeaderTitle}>Dividend Distribution</Text>
          </View>
      ...
      {onNext && (
          <View style={[{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 20, paddingTop: 16, marginTop: 4, borderTopWidth: 1, borderTopColor: 'rgba(226,232,240,0.8)' }, webCapWidth]}>
            ...
            <Text style={styles.stepLabelText}>STEP 4 OF 7</Text>
            <Pressable
        ...
        <View style={styles.inAppModalOverlay}>
          ...
          <View style={styles.modalCard}>
            <View style={styles.modalHeaderRow}>
              <Text style={styles.modalTitle}>Edit Dividend Details</Text>
            ...
            <ScrollView style={styles.modalFormScroll} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.modalFormGroup}>
                <Text style={styles.modalLabel}>Dividend Rate (%)</Text>
                <TextInput style={styles.modalInput} value={dividendRate} onChangeText={setDividendRate} placeholder="e.g. 8%" placeholderTextColor={COLORS.slate400} />
              </View>
