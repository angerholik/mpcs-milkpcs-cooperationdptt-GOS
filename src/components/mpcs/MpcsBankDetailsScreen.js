...
export default function MpcsBankDetailsScreen({
  ...
  React.useEffect(() => {
    ...
    if (initialAccount) setAccountNumber(initialAccount);
    if (initialIfsc) setIfscCode(initialIfsc);
    if (initialType) setAccountType(initialType);
  }, [initialBankName, initialBranch, initialAccount, initialIfsc, initialType]);

  const handleSave = () => {
    if (onSaveBankDetails) {
      onSaveBankDetails({ bankName, branch, accountNumber, ifscCode, accountType });
    }
    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.topBarTitleContainer}>
          ...
          <Text style={styles.screenTitleHeader}>Bank Details</Text>
        </View>
      </View>
        ...
        <View style={{ flexDirection: 'row', gap: 8 }}>
          <View style={[styles.btnWrapper, { flex: 1 }]}>
            ...
            >
              ...
              <Text style={styles.editCtaText}>Edit Bank Details</Text>
            </Pressable>
          </View>
      ...
      <ScrollView style={styles.scrollContent} contentContainerStyle={styles.scrollInner} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          <View style={styles.cardHeaderRow}>
            ...
            <Text style={styles.cardHeaderTitle}>Primary Bank Account</Text>
          </View>
          ...
          <View style={styles.modalCard}>
            ...
            <ScrollView style={styles.modalFormScroll} showsVerticalScrollIndicator={false}>
              ...
              <View style={styles.modalFormGroup}>
                ...
                <TextInput style={styles.modalInput} value={bankName} onChangeText={setBankName} placeholder="Enter bank name" placeholderTextColor={COLORS.slate400} />
              </View>

              <View style={styles.modalFormGroup}>
                <Text style={styles.modalLabel}>Branch Name</Text>
                <TextInput style={styles.modalInput} value={branch} onChangeText={setBranch} placeholder="Enter branch name" placeholderTextColor={COLORS.slate400} />
              </View>

              <View style={styles.modalFormGroup}>
                <Text style={styles.modalLabel}>Account Number</Text>
                <TextInput style={styles.modalInput} value={accountNumber} onChangeText={setAccountNumber} placeholder="Enter account number" placeholderTextColor={COLORS.slate400} />
              </View>

              <View style={styles.modalFormGroup}>
                <Text style={styles.modalLabel}>IFSC Code</Text>
                <TextInput style={styles.modalInput} value={ifscCode} onChangeText={setIfscCode} placeholder="Enter IFSC code" placeholderTextColor={COLORS.slate400} />
              </View>

              <View style={styles.modalFormGroup}>
                <Text style={styles.modalLabel}>Account Type</Text>
                <TextInput style={styles.modalInput} value={accountType} onChangeText={setAccountType} placeholder="e.g. Current Account" placeholderTextColor={COLORS.slate400} />
              </View>
