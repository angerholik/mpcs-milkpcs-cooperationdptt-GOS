    ...
    <View style={styles.container}>
      ...
      <View style={styles.topBar}>
        ...
        <View style={styles.topBarTitleContainer}>
          <Text style={styles.moduleTag}>MILK PCS MASTER DATA</Text>
      ...
      <ScrollView style={styles.scrollContent} contentContainerStyle={[styles.scrollInner, webCapWidth]} showsVerticalScrollIndicator={false}>
        ...
        {onNext && (
          <View style={[{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 20, paddingTop: 16, marginTop: 4, borderTopWidth: 1, borderTopColor: 'rgba(226,232,240,0.8)' }, webCapWidth]}>
            ...
            <Text style={styles.stepLabelText}>STEP 2 OF 4</Text>
            <Pressable
              ...
              <View style={styles.modalFormGroup}>
                ...
                <View style={{ flexDirection: 'row', gap: 10, marginTop: 4 }}>
                  {['Pending', 'Completed'].map((st) => (
                    <TouchableOpacity
                      key={st}
                      style={[styles.statusToggleChip, auditStatus === st && styles.statusToggleChipActive]}
                      onPress={() => setAuditStatus(st)}
                      activeOpacity={0.7}
                    >
                      <Text style={[styles.statusToggleText, auditStatus === st && styles.statusToggleTextActive]}>{st}</Text>
                    </TouchableOpacity>
                  ))}
                </View>
              </View>
              ...
              <View style={styles.modalFormGroup}>
                ...
                <View style={{ flexDirection: 'row', gap: 10, marginTop: 4 }}>
                  {['Pending', 'Completed'].map((st) => (
                    <TouchableOpacity
                      key={st}
                      style={[styles.statusToggleChip, agmStatus === st && styles.statusToggleChipActive]}
                      onPress={() => setAgmStatus(st)}
                      activeOpacity={0.7}
                    >
                      <Text style={[styles.statusToggleText, agmStatus === st && styles.statusToggleTextActive]}>{st}</Text>
                    </TouchableOpacity>
                  ))}
                </View>
              </View>
...
const styles = StyleSheet.create({
  ...
  screenTitleHeader: {
    color: '#FFFFFF', fontFamily: FONT_FAMILY, fontSize: 16, fontWeight: '800', letterSpacing: -0.16,
  },
  ...
  prevCircleBtn: {
    width: 48, height: 48, borderRadius: 24, backgroundColor: '#7a1a1f',
    alignItems: 'center', justifyContent: 'center',
  },
  nextCircleBtn: {
    width: 48, height: 48, borderRadius: 24, backgroundColor: '#ffffff',
    borderWidth: 1.5, borderColor: '#7a1a1f', alignItems: 'center', justifyContent: 'center',
  },
  stepLabelText: { fontFamily: FONT_FAMILY, fontSize: 11, fontWeight: '700', color: COLORS.slate400, letterSpacing: 0.6 },
  ...
  modalCard: {
    width: '100%', maxWidth: 500, alignSelf: 'center', backgroundColor: COLORS.surface,
    borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 20,
    paddingBottom: Platform.OS === 'ios' ? 34 : 20, maxHeight: '85%',
