      ...
      >
        ...
        <View style={styles.sectionHeaderRow}>
          ...
          <View style={styles.countBadge}>
            <Text style={styles.countBadgeText}>{activityList.length}</Text>
          </View>
        </View>
          ...
          activityList.map((item, idx) => (
            <View key={item.id} style={styles.actCard}>
              ...
              <View style={styles.actSeqBar}>
                <Text style={styles.actSeqText}>Entry #{activityList.length - idx}</Text>
              </View>
            </View>
          ))
        )}
...
const styles = StyleSheet.create({
  ...
  backBtn: { padding: 4, zIndex: 1, marginRight: 8 },
